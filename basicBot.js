...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/NatnatBot/basicBot/master/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            rulesLink: null,
            themeLink: null,
            fbLink: "https://goo.gl/cxz8zU",
            youtubeLink: null,
            website: "http://nextexitplugdj.weebly.com/",
            intervalMessages: [],
            messageInterval: 5,
            songstats: true,
            commandLiteral: "!",
        ...
        chatUtilities: {
            chatFilter: function (chat) {
                ...
                if(msg.indexOf("ciker") !== -1 || msg.indexOf("http://origem.woot.tk") !== -1 || msg.indexOf("party.dj") !== -1 || msg.indexOf("Ciker") !== -1 || msg.indexOf("ciker") !== -1 || msg.indexOf("party.dj") !== -1){                
                    API.moderateDeleteChat(chat.cid);
            ...
            spam: [
                ...
                'gringo', 'fuder', 'foder', 'hua', 'ahue', 'modafuka', 'modafoka', 'mudafuka', 'mudafoka', 'ooooooooooooooo' 
            ],
            curses: [
